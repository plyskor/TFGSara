...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{HOMOOrbitale}
	\caption{Arriba ,las estructuras de $CF_3COOH, CF_3COSH, CF_3SO_3H$, y abajo los orbitales moleculares HOMO de los aniones asociados a dichas estructuras.}
\end{figure}
\begin{table}[H]
    \centering
    \begin{tabular}{|c|c|c|c|c|c|}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{AIM-CH3COOH}\cite{AIM}
...
Como se ven en la figura 3.8 a medida que aumentamos el número de átomos de flúor, disminuye la densidad electrónica en el enlace O···H de 0,36 a 0,35. Ésto es debido a la capacidad atractora del flúor, el enlace O···H se debilita facilitando su ruptura, traduciéndose esto en un aumento de su acidez.
\begin{table}[H]
    \centering
...
Por otro lado, en el caso del ácido fosfórico observamos que ocurre al revés, esto es por la estabilidad molecular de la estructura, el hidrógeno ácido y el halógeno tienden a salir de ésta formando un enlace HX. 
...
Se puede apreciar como con la presencia de mayor número de átomos de flúor, la densidad del enlace O···H también decrece, y como consecuencia, la densidad en el enlace C=O aumenta de 0,4 a 0,42.

Si comparamos el enlace O-H en las moléculas con y sin interacción de una molécula de agua, observando la densidad en el punto crítico de dicho enlace, figuras 3.8 y 3.9, ésta desciende con la interacción de la molécula de agua ($H_3CCOOH$ de 0,360 a 0,335) .
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		Ácidos-$H_2O$ & distancia	& d(O$\cdots$H) ($\Armstrong$) & $\rho_{BCP} (u. a.)$ \\ \hline
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{lalala}
	\caption{Estructura molecular de hidratación del $CF_3COOH$ y del $H_3CCOOH$ y distancias internucleares de interés en $\Armstrong$}
\end{figure}
